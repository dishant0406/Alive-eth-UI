                ...
                <div className="sm:flex sm:items-start">
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2 mt-[1rem] flex w-[29rem] flex-col gap-[0.5rem] overflow-y-scroll h-[15rem]">
                      {items.map((item, i)=>{
                        return (
                          <button key={i} onClick={()=>handleClick(item.name)} className="w-[26rem] h-[2.5rem] hover:bg-gray transition hover:text-white text-gray flex items-center justify-center border border-gray">
