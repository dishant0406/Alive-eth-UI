...
import sampleImage from '/assets/Main/Images/UVR.png'
    ...
    <div className='h-[100vh] flex flex-col justify-start w-[100vw] bg-white'>
      <div className='w-[100vw] h-[370px] justify-start pt-[24px] gap-[24px] mb-[27px] flex flex-col items-center bg-gray alivebottomborderMobReaverse'>
        ...
        {isMobile && <div className='relative'>
          ...
          <button style={{ letterSpacing: '0.02em' }} className='flex absolute border border-gray px-[0.5rem] text-gray left-[116px] h-[36px] bottom-[36px] font-[700] gap-[0.5rem] bg-yellow justify-center font-[Citizen-OT-Medium] text-[18px]  items-center'>
          ...
          <div className=''>
            <Slider {...settings} className='w-[361px] h-[9rem] '>
              <div className='w-[301px] claimcard h-[150px] overflow-hidden border border-gray relative bg-yellow'>
                ...
                <p style={{ lineHeight: '28px', letterSpacing: '0.025em' }} className='text-[26px] text-gray w-[15rem] ml-[20px] font-[Citizen-OT-Medium] z-[5] font-[700] '>Claim your UVR mount now!</p>
              ...
              <div className=" claimcard h-[150px] overflow-hidden bg-red bg-cover border border-gray relative">
                <img src={Star.src} className='absolute h-[124px] bottom-[-0.2rem] right-[0] ' />
                <p style={{ lineHeight: '28px', letterSpacing: '0.025em' }} className='text-[26px] text-gray w-[13rem] ml-[20px] font-[Citizen-OT-Medium] z-[5] font-[700] '>Get 15% off on our next drop!</p>
                <button style={{ fontFamily: 'Nuform Sans' }} className='px-[12px] ml-[20px] py-[6px] text-[16px] text-gray font-[500] bg-yellow border border-gray'>claim</button>
              </div>
            </Slider>
          </div>
